...
.method public static a(Landroid/content/Context;Landroid/hardware/SensorEventListener;)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Lcom/bytedance/sdk/openadsdk/i/i;->b(Landroid/content/Context;)Landroid/hardware/SensorManager;
    ...
    .line 58
    invoke-static {p1, v0, p0}, Lcom/bytedance/sdk/openadsdk/i/f;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static a(Landroid/content/Context;Landroid/hardware/SensorEventListener;I)V
    ...
    invoke-static {p2}, Lcom/bytedance/sdk/openadsdk/i/i;->a(I)I
    ...
    .line 34
    invoke-static {p1, p2, p0}, Lcom/bytedance/sdk/openadsdk/i/f;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static b(Landroid/content/Context;)Landroid/hardware/SensorManager;
    ...
    .line 16
    sget-object v0, Lcom/bytedance/sdk/openadsdk/i/i;->a:Landroid/hardware/SensorManager;

    if-nez v0, :cond_1

    .line 17
    const-class v0, Lcom/bytedance/sdk/openadsdk/i/i;

    monitor-enter v0

    .line 18
    :try_start_0
    sget-object v1, Lcom/bytedance/sdk/openadsdk/i/i;->a:Landroid/hardware/SensorManager;
    ...
    sput-object p0, Lcom/bytedance/sdk/openadsdk/i/i;->a:Landroid/hardware/SensorManager;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/bytedance/sdk/openadsdk/i/i;->a:Landroid/hardware/SensorManager;
