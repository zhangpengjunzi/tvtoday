...
.method static constructor <clinit>()V
    ...
    :cond_0
    const-string v3, "yyyy-MM-dd HH:mm:ss.S \'UTC\'"

    .line 64
    :goto_0
    sput-object v3, Lcom/thoughtworks/xstream/converters/basic/DateConverter;->DEFAULT_PATTERN:Ljava/lang/String;

    if-eqz v1, :cond_1

    const-string v3, "yyyy-MM-dd G HH:mm:ss.S z"

    goto :goto_1

    :cond_1
    const-string v3, "yyyy-MM-dd G HH:mm:ss.S \'UTC\'"

    .line 65
    :goto_1
    sput-object v3, Lcom/thoughtworks/xstream/converters/basic/DateConverter;->DEFAULT_ERA_PATTERN:Ljava/lang/String;
    ...
    :cond_2
    const-string v2, "yyyy-MM-dd HH:mm:ss.S a"
    ...
    const-string v1, "yyyy-MM-dd HH:mm:ss \'UTC\'"
    ...
    const-string v1, "yyyy-MM-dd\'T\'HH:mm:ss.SX"
    ...
    const-string v1, "yyyy-MM-dd\'T\'HH:mmX"

    .line 80
    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_4
    const-string v1, "yyyy-MM-dd HH:mm:ssa"
    ...
    .line 89
    invoke-virtual {v0, v2, v1, v2}, Ljava/util/Calendar;->set(III)V
