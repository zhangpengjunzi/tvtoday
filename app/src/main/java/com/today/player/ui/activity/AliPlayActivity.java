...
public class AliPlayActivity extends BaseActivity {
    ...
    private void playSet() {
        ...
        videoAnalysis.a(this, new AliPlayActivity.a());
        ...
        if ((!TextUtils.isEmpty(playUrl) && !TextUtils.isEmpty(srcName) && mVodInfo.sourceKey.equals(srcName)) || (!TextUtils.isEmpty(playerUrl) && playerUrl.contains(basePlb))) {
            ...
            if (playerUrl.contains(basePlb) && playUrl.endsWith("m3u8")) {
                AliPlayActivity.PlayStart playStart = new AliPlayActivity.PlayStart();
                playStart.a(playUrl);
            } else {
                setUrl(playerUrl);
            }
        ...
        videoAnalysis.a(sourceKey, mVodInfo.fromList.get(mVodInfo.playFlag).name, playUrl, new AliPlayActivity.PlayStart());
    }
