...
public class ControlView extends RelativeLayout implements ViewAction, ITheme {
    ...
    //切换模式
    private OnChangeScaleModeListener mOnChangeScaleModeListener;
    //视频广告时长
    ...
    //切换播放速度
    private TextView video_speed, video_size, tv_video_speed, tv_video_size, tv_pause_progress_text;
    private LinearLayout tv_bottom_area, speedScaleArea, tv_pause_container;
    ...
    private void findAllViews() {
     ...
     /*   mScreenShot = findViewById(R.id.alivc_screen_shot);
        ...
        video_size = findViewById(R.id.video_size);
        tv_video_speed = findViewById(R.id.tv_video_speed);
        tv_video_size = findViewById(R.id.tv_video_size);
        tv_bottom_area = findViewById(R.id.tv_bottom_area);
        speedScaleArea = findViewById(R.id.speedScaleArea);
        ...
        tv_pause_container = findViewById(R.id.tv_pause_container);
...
//        });
       ...
       /* mScreenRecorder.setOnClickListener(new OnClickListener() {
        ...
        tv_video_size.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnChangeScaleModeListener != null) {
                    IPlayer.ScaleMode scaleMode = IPlayer.ScaleMode.SCALE_ASPECT_FIT;
                    String text = tv_video_size.getText().toString();
                    if (text.equals(getContext().getResources().getString(R.string.alivc_scale_aspect_fit))) {
                        scaleMode = IPlayer.ScaleMode.SCALE_ASPECT_FILL;
                        tv_video_size.setText(getContext().getResources().getString(R.string.alivc_scale_aspect_fill));
                    } else if (text.equals(getContext().getResources().getString(R.string.alivc_scale_aspect_fill))) {
                        scaleMode = IPlayer.ScaleMode.SCALE_TO_FILL;
                        tv_video_size.setText(getContext().getResources().getString(R.string.alivc_scale_to_fill));
                    } else if (text.equals(getContext().getResources().getString(R.string.alivc_scale_to_fill))) {
                        scaleMode = IPlayer.ScaleMode.SCALE_ASPECT_FIT;
                        tv_video_size.setText(getContext().getResources().getString(R.string.alivc_scale_aspect_fit));
                    }
                    mOnChangeScaleModeListener.changeScaleMode(scaleMode);
                    hideDelayed();
                }
            }
        });

        tv_video_size.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
        ...
        tv_video_speed.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    hideDelayed();
        ...
        tv_video_speed.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnChangeSpeedListener != null) {
                    SpeedValue speedValue = SpeedValue.One;
                    if (tv_video_speed.getText().toString().equals("x1")) {
                        speedValue = SpeedValue.OneHalf;
                        tv_video_speed.setText("x1.5");
                    } else if (tv_video_speed.getText().toString().equals("x1.5")) {
                        speedValue = SpeedValue.Twice;
                        tv_video_speed.setText("x2");
                    } else if (tv_video_speed.getText().toString().equals("x2")) {
                        speedValue = SpeedValue.OneQuartern;
                        tv_video_speed.setText("x0.5");
                    } else if (tv_video_speed.getText().toString().equals("x0.5")) {
                        speedValue = SpeedValue.One;
                        tv_video_speed.setText("x1");
                    }
                    mOnChangeSpeedListener.changeSpeed(speedValue);
                    hideDelayed();
                }
            }
        });

        video_size.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mOnChangeScaleModeListener != null) {
                    IPlayer.ScaleMode scaleMode = IPlayer.ScaleMode.SCALE_ASPECT_FIT;
                    String text = video_size.getText().toString();
                    if (text.equals(getContext().getResources().getString(R.string.alivc_scale_aspect_fit))) {
                        scaleMode = IPlayer.ScaleMode.SCALE_ASPECT_FILL;
                        video_size.setText(getContext().getResources().getString(R.string.alivc_scale_aspect_fill));
                    } else if (text.equals(getContext().getResources().getString(R.string.alivc_scale_aspect_fill))) {
                        scaleMode = IPlayer.ScaleMode.SCALE_TO_FILL;
                        video_size.setText(getContext().getResources().getString(R.string.alivc_scale_to_fill));
                    } else if (text.equals(getContext().getResources().getString(R.string.alivc_scale_to_fill))) {
                        scaleMode = IPlayer.ScaleMode.SCALE_ASPECT_FIT;
                        video_size.setText(getContext().getResources().getString(R.string.alivc_scale_aspect_fit));
                    }
                    mOnChangeScaleModeListener.changeScaleMode(scaleMode);
                }
            }
        ...
        video_speed.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mOnChangeSpeedListener != null) {
                    SpeedValue speedValue = SpeedValue.One;
                    if (video_speed.getText().toString().equals("x1")) {
                        speedValue = SpeedValue.OneHalf;
                        video_speed.setText("x1.5");
                    } else if (video_speed.getText().toString().equals("x1.5")) {
                        speedValue = SpeedValue.Twice;
                        video_speed.setText("x2");
                    } else if (video_speed.getText().toString().equals("x2")) {
                        speedValue = SpeedValue.OneQuartern;
                        video_speed.setText("x0.5");
                    } else if (video_speed.getText().toString().equals("x0.5")) {
                        speedValue = SpeedValue.One;
                        video_speed.setText("x1");
                    }
                    mOnChangeSpeedListener.changeSpeed(speedValue);
                }
            }
...
//        });
    ...
    public void showBottomArea() {
        ...
        mScreenLockBtn.setVisibility(View.GONE);
        mControlBar.setVisibility(View.GONE);
        speedScaleArea.setVisibility(View.GONE);
        tv_pause_container.setVisibility(View.GONE);
        tv_bottom_area.setVisibility(VISIBLE);
        mHideHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                tv_video_speed.requestFocus();
            }
        }, 200);
    ...
    public void showPauseContainer(String time) {
        setVisibility(View.VISIBLE);
        mScreenCostLinearLayout.setVisibility(View.GONE);
        mTitleBar.setVisibility(View.GONE);
        mScreenLockBtn.setVisibility(View.GONE);
        mControlBar.setVisibility(View.GONE);
        speedScaleArea.setVisibility(View.GONE);
        tv_bottom_area.setVisibility(GONE);
        tv_pause_container.setVisibility(View.VISIBLE);
        tv_pause_progress_text.setText(time);
    }


    public boolean isBottomShow() {
        return getVisibility() == View.VISIBLE && tv_bottom_area.getVisibility() == View.VISIBLE;
    }

    public void hideBottomArea() {
        setVisibility(View.GONE);
        if (tv_pause_container.getVisibility() == View.VISIBLE) {
            tv_pause_container.setVisibility(View.GONE);
        }
        if (tv_bottom_area.getVisibility() == View.VISIBLE) {
            tv_bottom_area.setVisibility(View.GONE);
        }
    }
...
//        }
    ...
    public void show() {
        if (mHideType == HideType.End) {
            ...
            if (!isLivePlay) {
                ...
                tv_bottom_area.setVisibility(View.GONE);
                tv_pause_container.setVisibility(View.GONE);
                speedScaleArea.setVisibility(View.VISIBLE);
                hideDelayed();
            }
        }
    }
    ...
    public void hide(HideType hideType) {
        ...
        if (tv_pause_container.getVisibility() == View.GONE) {
            setVisibility(GONE);
        }
        hideQualityDialog();
    }
    ...
    public void setOnChangeSpeedListener(OnChangeSpeedListener mOnChangeSpeedListener) {
        this.mOnChangeSpeedListener = mOnChangeSpeedListener;
    }

    public void setOnChangeScaleModeListener(OnChangeScaleModeListener mOnChangeScaleModeListener) {
        this.mOnChangeScaleModeListener = mOnChangeScaleModeListener;
    }
    ...
    public interface OnChangeSpeedListener {
        void changeSpeed(SpeedValue speed);
    }

    public interface OnChangeScaleModeListener {
        void changeScaleMode(IPlayer.ScaleMode scaleMode);
    }
