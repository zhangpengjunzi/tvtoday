...
public class SeekDialog extends BaseGestureDialog {
    ...
    public SeekDialog(Activity activity, int position, int duration, boolean isLeft) {
        super(activity);
    ...
    public void updatePosition(int position, boolean isLeft) {
        ...
        mTextView.setText(TimeFormater.formatMs(position) + "/" + TimeFormater.formatMs(mDuration));
    }
