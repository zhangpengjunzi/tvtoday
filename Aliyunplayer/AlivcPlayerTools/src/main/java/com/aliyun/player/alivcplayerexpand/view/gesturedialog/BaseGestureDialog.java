...
public class BaseGestureDialog extends PopupWindow {
    ...
    public BaseGestureDialog(Context context) {
        ...
        //设置对话框宽高
        mDialogWidth = context.getResources().getDimensionPixelSize(R.dimen.alivc_player_gesture_dialog_width_size);
        mDialogHeight = context.getResources().getDimensionPixelSize(R.dimen.alivc_player_gesture_dialog_height_size);
        setWidth(mDialogWidth);
        setHeight(mDialogHeight);
    }
    ...
    public void show(View parent) {
        ...
        //保证显示居中
        int x = location[0] + (parent.getRight() - parent.getLeft() - mDialogWidth) / 2;
        int y = location[1] + (parent.getBottom() - parent.getTop() - mDialogHeight) / 2;
